...
treino_x, teste_x, treino_y, teste_y = train_test_split(x, y, stratify=y, random_state=20, test_size=0.25)
...
rede = NeuralNetwork(arquitetura, 0.05, 1000)
